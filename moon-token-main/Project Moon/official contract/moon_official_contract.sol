 /* SPDX-License-Identifier: MIT
    moon (dust) token
    high liquidity fees, low engineering payouts, high rocket fuel cost
    our mission is to create a base on the moon to help aid future space exploration for the human race
    there are no marketing wallets nor charity wallets in this Contract, ownership will be renounced and liquidity locked for (tbd) months.
    contract has been deployed with other tokens however slight changes have been made and lessons learned.
    callie, collin too the moon!

    quick tokenomics
      maximum supply      [total tokens]               =                1,000,000,000,000,000 (one quadrillion)
      decimals            [decimals]                   =                18
     -maxLiqFee           [liquidity]                  =           6%   rocket fuel isnt cheap (no it is not)
     -maxTaxFee           [reflections]                =           1%   company dividends for engineer payouts (the hodlers)
     -maxBurnFee          [token burn]                 =           8%   environmental charges (goverment cut)
     -maxWalletFee        [set as burn wallet]         =           0%   we dont need marketing, the moon is right there she's shining bright

     fuck elon & mars... for now 
*/
...
contract moon is Context, IERC20, Ownable {
    ...
    /*------Fees-----
        maxLiqFee =     Liquidity, rocket fuel isnt cheap
        maxTaxFee =     company dividends for engineer payouts (the hodlers)
        maxBurnFee =    environmental charges
        maxWalletFee =  we dont need marketing, the moon is right there she's shining bright
    */
    uint8 public maxLiqFee = 6;               
    uint8 public maxTaxFee = 1;                
    uint8 public maxBurnFee = 8;               
    uint8 public maxWalletFee = 0;             
 
    /*------Anti-Buyouts-----
        the below is for anti whales, can and my be changed depending on engineering needs
    */
    uint8 public minMxTxPercentage = 1;       
    uint8 public minMxWalletPercentage = 1;   

    /*------Company Buyback Fee-----
        maxBuybackFee = the fee is cost the owner to purchase back dust
    */ 
